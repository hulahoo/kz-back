CREATE or replace VIEW TSADV_ALL_ABSENCE_REQUEST as
SELECT r.id,
       r."version",
       r.create_ts,
       r.created_by,
...
SELECT l.id,
       ...
       null,
       l.status_id,
       sys_config_value('tal.hr.absenceType.leavingVacationRequest')::uuid as type_id,
       l.request_date,
       l.request_number,
       'tsadv$LeavingVacationRequest'                                      as entity_name,
       l.comment_,
       l.integration_user_login,
       l.legacy_id,
       l.organization_bin
...
SELECT l.id,
       ...
       l.delete_ts,
       l.deleted_by,
       l.recall_date_from                                            as start_date,
       l.recall_date_to                                              as end_date,
       ab.person_group_id,
       null,
       l.status_id,
       sys_config_value('tal.hr.absenceType.absenceForRecall')::uuid as type_id,
       l.request_date,
       l.request_number,
...
SELECT l.id,
       ...
       l.delete_ts,
       l.deleted_by,
       l.NEW_START_DATE                                                      as start_date,
       l.NEW_END_DATE                                                        as end_date,
       ab.person_group_id,
       null,
       l.status_id,
       sys_config_value('tal.hr.absenceType.changeAbsenceDaysRequest')::uuid as type_id,
       l.request_date,
       l.request_number,
