...
create table TSADV_PERFORMANCE_PLAN_JOB_GROUP_LINK (
    PERFORMANCE_PLAN_ID uuid,
    JOB_GROUP_ID uuid,
    primary key (PERFORMANCE_PLAN_ID, JOB_GROUP_ID)
)^
...
create table TSADV_PERFORMANCE_PLAN_POSITION_GROUP_LINK (
    PERFORMANCE_PLAN_ID uuid,
    POSITION_GROUP_ID uuid,
    primary key (PERFORMANCE_PLAN_ID, POSITION_GROUP_ID)
)^
...
create table TSADV_RC_JOB_GROUP_JOB_GROUP_LINK (
    RC_JOB_GROUP_ID uuid,
    JOB_GROUP_ID uuid,
    primary key (RC_JOB_GROUP_ID, JOB_GROUP_ID)
)^
...
create table TSADV_PERFORMANCE_PLAN_ORGANIZATION_GROUP_LINK (
    PERFORMANCE_PLAN_ID uuid,
    ORGANIZATION_GROUP_ID uuid,
    primary key (PERFORMANCE_PLAN_ID, ORGANIZATION_GROUP_ID)
)^
...
alter table BASE_PERSON add column FIOWITHEMPLOYEENUMBERWITHSORTSUPPORTED varchar(255) ^
...
alter table BASE_ASSIGNMENT add column DTYPE varchar(100) ^
...
alter table BASE_PARTY add column DTYPE varchar(100) ^
...
-- begin TSADV_ABSENCE_REQUEST_STATUS
create table TSADV_ABSENCE_REQUEST_STATUS (
    ID uuid,
    VERSION integer not null,
    CREATE_TS timestamp,
    CREATED_BY varchar(50),
...
-- end TSADV_ABSENCE_REQUEST_STATUS
