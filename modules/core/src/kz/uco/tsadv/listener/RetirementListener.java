 ...
 */
@Component("tsadv_RetirementListener")
public class RetirementListener implements AfterDeleteEntityListener<Retirement>,
        AfterInsertEntityListener<Retirement>,
        AfterUpdateEntityListener<Retirement> {

    @Inject
    protected IntegrationConfig integrationConfig;

    @Override
    public void onAfterDelete(Retirement entity, Connection connection) {
        callUpdatePersonIntegration(entity.getPersonGroupExt(), connection);
    }

    @Override
    public void onAfterInsert(Retirement entity, Connection connection) {
        callUpdatePersonIntegration(entity.getPersonGroupExt(), connection);
    }

    @Override
    public void onAfterUpdate(Retirement entity, Connection connection) {
        callUpdatePersonIntegration(entity.getPersonGroupExt(), connection);
    }
