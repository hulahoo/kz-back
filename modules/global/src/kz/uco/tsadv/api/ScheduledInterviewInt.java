...
@MetaClass(name = "tsadv$ScheduledInterviewInt")
public class ScheduledInterviewInt extends AbstractEntityInt {
    private static final long serialVersionUID = 4739384326317938537L;
    ...
    @MetaProperty
    protected Integer availableRequestCount;
    ...
    public void setAvailableRequestCount(Integer availableRequestCount) {
        this.availableRequestCount = availableRequestCount;
    }

    public Integer getAvailableRequestCount() {
