...
@Entity(name = "tsadv_InsuranceContract")
public class InsuranceContract extends StandardEntity {
    ...
    @OneToMany(mappedBy = "insuranceContract")
    private List<InsuranceContractAdministrator> contractAdministrators;
    ...
    public List<InsuranceContractAdministrator> getContractAdministrators() {
        return contractAdministrators;
    }

    public void setContractAdministrators(List<InsuranceContractAdministrator> contractAdministrators) {
