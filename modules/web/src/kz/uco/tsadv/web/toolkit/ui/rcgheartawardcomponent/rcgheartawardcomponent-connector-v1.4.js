    ...
    function initPage() {
        ...
        function initTemplate() {
            ...
            function initWinners() {
                var organizationGroupId = "-1", year = currentYear, winLastYear = lastYear, onChange = false;
                ...
                initYears();
                initOrganizations();
                loadWinners(true, $yearSelect);

                function loadWinners(init, $selectDate) {
                    $.ajax({
                        'url': webAppUrl + "/rest/v2/services/tsadv_RecognitionService/loadTopNomineeWithDefault",
                        data: {
                            currentYear: year,
                            organizationGroupId: organizationGroupId,
                            lastYear: winLastYear,
                            onChange: onChange
                        },
                        'dataType': 'json',
                        'beforeSend': function (request) {
