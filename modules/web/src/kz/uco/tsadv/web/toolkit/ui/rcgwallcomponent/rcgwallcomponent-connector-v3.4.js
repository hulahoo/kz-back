kz_uco_tsadv_web_toolkit_ui_rcgwallcomponent_RcgWallComponent = function () {
    ...
    connector.onStateChange = function () {
        ...
        if (ra) {
            if (ra === 'preferences') {
                ...
                if (refreshTopTenTabs !== null) {
                    refreshTopTenTabs.apply();
                }
            }
        }
    };
    ...
    if (pageName === 'profile' || pageName === 'main' || pageName === 'feedback') {
        ...
        if (pageName === 'main') {
            ...
            var loadTopTenContentTabIndex = 0;

            refreshTopTenTabs = function () {
                loadTopTenContent(loadTopTenContentTabIndex);
            };
