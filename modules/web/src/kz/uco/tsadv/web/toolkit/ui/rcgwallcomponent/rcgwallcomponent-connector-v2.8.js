kz_uco_tsadv_web_toolkit_ui_rcgwallcomponent_RcgWallComponent = function () {
    ...
    if (pageName === 'profile' || pageName === 'main' || pageName === 'feedback') {
        ...
        if (pageName === 'main') {
            ...
            $('<div/>', {
                ...
                append: $('<div/>', {
                    ...
                    append: $('<div/>', {
                        class: 'rcg-hello-text',
                        text: messageBundle['rcg.feedback.wt']
                    })
                }).add($('<div/>', {
                    class: 'col-lg-6 col-md-6 col-sm-6 col-xs-12 rcg-mmc-header-r rcg-align-r',
                    append: $('<a/>', {
        ...
        if (pageName === 'main') {
            ...
            var $topTenMonths = $('<ul/>', {
                class: 'rcg-block-b-content-tabs clearfix',
                append: $('<li/>', {
                    append: $('<a/>', {
                        text: messageBundle['top.months.1'],
                        click: function () {
                            loadTopTenContent(0, this)
                        }
                    }),
                    ...
                    append: $('<a/>', {
                        text: messageBundle['top.months.2'],
                        click: function () {
                            loadTopTenContent(1, this)
                        }
                    }),
                    ...
                    append: $('<a/>', {
                        text: messageBundle['top.months.3'],
                        click: function () {
                            loadTopTenContent(2, this)
                        }
                    }),
                    'data-months': 6
                })).add($('<li/>', {
                    append: $('<a/>', {
                        text: messageBundle['top.months.4'],
                        click: function () {
                            loadTopTenContent(3, this)
                        }
                    }),
                    'data-months': 12
                })).add($('<li/>', {
                    append: $('<a/>', {
                        text: messageBundle['top.months.5'],
                        click: function () {
                            loadTopTenContent(4, this)
                        }
                    })
                }))
            });
                ...
                append: $('<div/>', {
                    ...
                    append: $topTenTabs
                        .add($('<div/>', {
                            ...
                            append: [$topTenMonths, $topTenTable]
                        }))
                })).add($('<div/>', {
                    class: 'rcg-block-f',
                    append: $toggleLink
            ...
            function loadTopTenContent(tab, tabElem) {
                $topTenLoader.show();
                var $te = $(tabElem),
                    $ul = $te.closest('ul');
                ...
                var li = [];
                if (tabElem) {
                    if ($ul[0] === $topTenTabs[0]) {
                        li.push($topTenTabs.find('li'));
                    } else {
                        li.push($topTenMonths.find('li'));
                    }
                } else {
                    li.push($topTenTabs.find('li'));
                    li.push($topTenMonths.find('li'));
                ...
                $.each(li, function (k, v) {
                    var $el = v.eq(tab);
                    $el.addClass('b-tab-active');
                });

                if (tabElem) {
                    data.countOfMonths = $('ul.rcg-block-b-content-tabs li.b-tab-active').data("months");
                } else {
                    data.countOfMonths = 0;
                }
                var indexTab = $('ul.rcg-block-b-tabs li.b-tab-active').index(),
                    method = indexTab === 0 || indexTab === -1 ? 'loadTopAwarded' : 'loadTopSender';

                loadTopTenData(method, data);

                function loadTopTenData(method, data) {
                    $topTenTable.empty();
            ...
            function makeFeedback(item) {
                ...
                var $wallAuthors = $('<div>', {
                    ...
                    append: $('<a>', {
                        ...
                        text: currentTab === 'SEND' ? item.receiver.name : item.sender.name,
                        click: function () {
                            connector.openProfilePage(currentTab === 'SEND' ? item.receiver.id : item.sender.id);
                        }
                    }).add($('<span>', {
                        class: 'rcg-type',
                        text: item.say
            ...
            function renderChart(chartData) {
                AmCharts.makeChart("rf-chart", {
                    ...
                    "graphs": [{
                        ...
                        "labelText": "[[value]]",
                        "lineAlpha": 0.3,
                        "title": chartFeedbackTypes['cat1'],
                        "type": "column",
                        "color": "#000000",
                        "valueField": "cat1"
                    }, {
                        "balloonText": "<b>[[title]]</b><br><span style='font-size:13px'>[[category]]: <b>[[value]]</b></span>",
                        "fillAlphas": 0.8,
                        "labelText": "[[value]]",
                        "lineAlpha": 0.3,
                        "title": chartFeedbackTypes['cat2'],
                        "type": "column",
                        "color": "#000000",
                        "valueField": "cat2"
                    }, {
