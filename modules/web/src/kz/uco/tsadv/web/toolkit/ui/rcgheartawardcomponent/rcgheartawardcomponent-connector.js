    ...
    function initPage() {
        ...
        function initTemplate() {
            ...
            function initAllNominees() {
                var amOrgGroupId = "-1", amYear = currentYear;
                ...
                function loadNominees() {
                    ...
                    $.ajax({
                        'url': webAppUrl + "/rest/v2/services/tsadv_RecognitionService/loadAllNominee",
                        data: {
                            page: currentPage,
                        ...
                        if (data) {
                            ...
                            if (recordsCount > 0 && (nominees && nominees.length > 0)) {
                                ...
                                if (init) {
                                    $amTableBody.append(emptyAmBlock('there.nothing'));
                                }
                            }
                        }
                    }).fail(function (jqXHR, textStatus, error) {
                        ...
                        return $('<tr/>', {
                            append: $('<td/>', {
                                append: $('<a/>', {
                                    ...
                                    click: function () {
                                        connector.readStoryFull(JSON.stringify(nominee));
                                    }
                                }),
                                prepend: $('<img/>', {
                                    src: nominee.image
                    ...
                    $.ajax({
                        ...
                        if (data) {
                            ...
                            if (count > 0) {
                                ...
                                $winnerList.append(emptyBlock('there.nothing'));
                            }
                        }
                    }).fail(function (jqXHR, textStatus, error) {
                    ...
                    $.ajax({
                        ...
                        if (data) {
                            ...
                            if (recordsCount > 0 && (nominees && nominees.length > 0)) {
                                ...
                                if (init) {
                                    $mnTableBody.append(emptyMnBlock('there.nothing'));
                                }
                            }
                        }
                    }).fail(function (jqXHR, textStatus, error) {
