kz_uco_tsadv_web_toolkit_ui_rcgshopcomponent_RcgShopComponent = function () {
    ...
    function initPage() {
        ...
        var $rcgCart = $('<span/>', {
            ...
            text: goodsCartCount === 0 ? messageBundle['shop.cart.empty'] : goodsCartCount + ' ' + messageBundle['shop.cart.count'],
            click: function () {
                if (pageName !== 'cart') {
        ...
        $win.bind('refreshGoodsCartCountEvent', function () {
            ...
            $rcgCart.get(0).lastChild.nodeValue = goodsCartCount + ' ' + messageBundle['shop.cart.count'];
        });
        ...
        if (pageName === 'shop') {
            ...
            function calculateTotalSum() {
                ...
                if ($counters) {
                    ...
                    if (hasDiscount) {
                        sum = Math.round(sum * Number(heartAwardDiscount) / 100);
                    }
                }
