        ...
        function loadRcgFeedbackTab() {
            ...
            function makeFeedback(item) {
                ...
                if (attachments) {
                    ...
                    $attachmentsW.on('onBeforeSlide.lg', function (e, pi, i, fromTouch, fromThumb) {
                        $rcgBodyWrapper.find('#video1').remove();

                        var $el = $(this).find('a').eq(i);
                        if ($el.attr('type') === 'VIDEO') {
                            $rcgBodyWrapper.append($('<div/>', {
                                id: 'video1',
                                append: $('<video/>', {
                    ...
                    $attachmentsW.on('onCloseAfter.lg', function () {
                        $rcgBodyWrapper.find('#video1').remove();
                    });

                    $rcgBodyWrapper.append($attachmentsW);
                }
