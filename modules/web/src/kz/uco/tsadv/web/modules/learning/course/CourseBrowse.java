...
public class CourseBrowse extends StandardLookup<Course> {
    ...
    @Inject
    protected CollectionContainer<Course> coursesDc;
    @Inject
    ...
    protected CreateActionExt coursesTableCreate;
    @Inject
    ...
    @Inject
    protected CollectionLoader<Course> coursesDl;
    @Inject
    ...
    protected void onInit(InitEvent event) {
        ...
        coursesDc.addItemChangeListener(e -> {
        ...
        coursesTableCreate.setAfterCommitHandler(entity -> coursesDl.load());
    }
...
//    }
    ...
    public void createEnrollments() {
        screenBuilders.lookup(Enrollment.class, this)
        .build().show();
